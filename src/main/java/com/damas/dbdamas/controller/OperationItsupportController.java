...
import com.damas.dbdamas.service.OperationItsupportService;
...
public class OperationItsupportController {
    ...
    public WebResponse<OperationItsupportResponse> editedItsupport(
            ...
            @RequestParam ("input") String input){
        OperationItsupportResponse OperationItsupportResponse = operationItsupportService.editedItsupport(userid, request, input);

package com.damas.dbdamas.service.Logistic;
...
import com.damas.dbdamas.payload.Logistic.LogisticMemoRequest;
import com.damas.dbdamas.payload.Logistic.LogisticMemoResponse;
import com.damas.dbdamas.repository.Logistic.LogisticMemoRepository;
        ...
        public List<LogisticMemoResponse> findAll(String userid, Long start, Long size) {
                ...
                return logisticMemos.stream()
                                ...
                                .map(item -> LogisticMemoResponse.builder()
                                                ...
                                                .memo_deadline(item.getMemo_deadline())

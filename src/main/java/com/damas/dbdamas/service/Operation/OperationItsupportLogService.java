...
import com.damas.dbdamas.payload.Operation.OperationItsupportLogResponse;
import com.damas.dbdamas.payload.Operation.OperationItsupportRequest;
import com.damas.dbdamas.repository.Operation.OperationItsupportLogRepository;
...
public class OperationItsupportLogService {
    ...
    @Transactional
     public String createLog(String userid, OperationItsupportLog request) {
        ...
        if (!(validationSecureService.isOperator(userid) || validationSecureService.isItsupportOperator(userid))) {

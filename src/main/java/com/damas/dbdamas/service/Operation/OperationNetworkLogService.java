...
import com.damas.dbdamas.payload.Operation.OperationNetworkLogResponse;
import com.damas.dbdamas.payload.Operation.OperationNetworkRequest;
import com.damas.dbdamas.repository.Operation.OperationNetworkLogRepository;
...
public class OperationNetworkLogService {
    ...
    public String updateStatusLog(String userid, String id, String network_status) {
        ...
        inputRequestOperationNetwork.setUserdomain(result.getUserdomain());
        inputRequestOperationNetwork.setUserdomain_pic(result.getUserdomain_pic());

...
public class OperationItmoService {
    ...
    @Transactional
    public OperationItmoResponse newItmo(OperationItmoRequest userid, String token) {
        validationService.validateRequest(userid);

        OperationItmo operationItmo = new OperationItmo();
        operationItmo.setItmo_perihal(userid.getItmo_perihal());
        operationItmo.setItmo_pic(userid.getItmo_pic());
        operationItmo.setDepartement(userid.getDepartement());
        operationItmo.setItmo_phase1(userid.getItmo_phase1());
        operationItmo.setItmo_phase1_start(userid.getItmo_phase1_start());
        operationItmo.setItmo_phase1_deadline(userid.getItmo_phase1_deadline());
        operationItmo.setItmo_phase1_done(userid.getItmo_phase1_done());
        operationItmo.setItmo_phase2(userid.getItmo_phase2());
        operationItmo.setItmo_phase2_start(userid.getItmo_phase2_start());
        operationItmo.setItmo_phase2_deadline(userid.getItmo_phase2_deadline());
        operationItmo.setItmo_phase2_done(userid.getItmo_phase2_done());
        operationItmo.setItmo_phase3(userid.getItmo_phase3());
        operationItmo.setItmo_phase3_start(userid.getItmo_phase3_start());
        operationItmo.setItmo_phase3_deadline(userid.getItmo_phase3_deadline());
        operationItmo.setItmo_phase3_done(userid.getItmo_phase3_done());
        operationItmo.setItmo_phase4(userid.getItmo_phase4());
        operationItmo.setItmo_phase4_start(userid.getItmo_phase4_start());
        operationItmo.setItmo_phase4_deadline(userid.getItmo_phase4_deadline());
        operationItmo.setItmo_phase4_done(userid.getItmo_phase4_done());
        operationItmo.setItmo_phase5(userid.getItmo_phase5());
        operationItmo.setItmo_phase5_start(userid.getItmo_phase5_start());
        operationItmo.setItmo_phase5_deadline(userid.getItmo_phase5_deadline());
        operationItmo.setItmo_phase5_done(userid.getItmo_phase5_done());
        operationItmo.setItmo_phase6(userid.getItmo_phase6());
        operationItmo.setItmo_phase6_start(userid.getItmo_phase6_start());
        operationItmo.setItmo_phase6_deadline(userid.getItmo_phase6_deadline());
        operationItmo.setItmo_phase6_done(userid.getItmo_phase6_done());
        operationItmo.setItmo_phase7(userid.getItmo_phase7());
        operationItmo.setItmo_phase7_start(userid.getItmo_phase7_start());
        operationItmo.setItmo_phase7_deadline(userid.getItmo_phase7_deadline());
